...
public class PredicateBuilder<TSource> where TSource : class
{
    ...
    public static Expression<Func<TSource, bool>> Or(Expression<Func<TSource, bool>> left,
    ...
    /// <param name="right">Right expression</param>
    /// <returns>Joined expression</returns>
    public static Expression<Func<TSource, bool>> And(Expression<Func<TSource, bool>> left,
        Expression<Func<TSource, bool>> right)
    {
        ArgumentNullException.ThrowIfNull(left);
        ArgumentNullException.ThrowIfNull(right);
